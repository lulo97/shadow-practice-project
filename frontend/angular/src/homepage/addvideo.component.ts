...
@Component({
  standalone: true,
  imports: [FormsModule],
  template: `<div id="add-video-container" class="p-4 max-w-lg">
    <div id="form-group-link" class="mb-3">
      <label
        id="lbl-ytb-link"
    ...
    <p id="desc-note" class="mt-4 text-sm text-gray-500 leading-relaxed">
      We will download the video, extract English subtitles (or use ASR if
      needed), and process it in the background.
    </p>
  </div>`,
})
