...
@Component({
  ...
  >
    ...
    <div
      class="w-full max-w-sm p-6 bg-white border-4 border-black shadow-[8px_8px_0px_0px_#000] relative z-10"
    >
      <div class="flex flex-col items-center mb-8">
        ...
        <div
          class="inline-block bg-[#FFDE4D] text-black px-3 py-1 text-xs font-black border-2 border-black uppercase tracking-widest shadow-[2px_2px_0px_0px_#000] mb-3"
        >
          System_Access
        </div>
      ...
      <div class="space-y-6">
        <div>
          <label class="block font-black text-xs uppercase mb-2"
        ...
        <div class="flex items-center justify-between py-1">
          <label
            class="flex items-center text-xs font-bold uppercase cursor-pointer select-none"
          >
            <input
              type="checkbox"
